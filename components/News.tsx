...
const News = () => {
    return (
            ...
            <Box rounded = 'lg' boxShadow='md' bg="#ffffff" maxW="3xl" mx="auto" p={4}>
                ...
                <Link href="https://www.youtube.com/watch?v=4HHOuDnW2DQ&feature=emb_logo&fbclid=IwAR3vxB3jC2TkUP9hWTp-9fEqgQ6xlOFKLSRTll5fj6NOjZqtpUzTrAX9tw8" isExternal>
                    <Icon name="chevron-right" mx="2px" /> Painel da SBF: Físicos e a Pandemia <Icon name="external-link" mx="2px" />
                </Link> <br/>
