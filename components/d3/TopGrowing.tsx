...
class TopGrowing extends Component {
  ...
  componentDidMount() {
    ...
    this.runtime.module(notebook, (name: string) => {
      if (name === "table") return Inspector.into("#observablehq-b9b69f31 .observablehq-table")();
      if (name === "confirmedMovingAvg")
        return Inspector.into("#observablehq-b9b69f31 .observablehq-confirmedMovingAvg")();
    });
  }
    ...
    return (
      <div className="TopGrowing">
        <div id="observablehq-b9b69f31">
          ...
          <div className="observablehq-confirmedMovingAvg" style={{ display: "none" }}></div>
        </div>
      </div>
    );
  }
