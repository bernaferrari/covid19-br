import { Box, Container, Image, Link, Separator, Text } from "@chakra-ui/react";
...
import { SectionTitle, SectionSubtitle, SectionTitleAbout } from "../components/SectionTitles";
...
const AdaptiveBox = (props: ComponentProps<typeof Box>) => (
  <Box width={{ base: "100%", md: "50%" }} py={4} {...props} />
);
        ...
        <TextImageContainer>
          <StyledFlex>
            <AdaptiveBox>
              ...
              <SectionSubtitle color="white">Brasil (acumulado e diário)</SectionSubtitle>
              <Box h={4} />
